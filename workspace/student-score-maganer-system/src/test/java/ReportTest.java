...
//
//        //when
//        String result = report.buildReport(studentsIDs);
//        //then
...
//        Report report = new Report(klass);
//
//        assertThat(report.buildReport(studentsIDs), is(String.format(outputString, stuZS + stuLS)));
//
//    }
//
//    @Test
...
//        Report report = new Report(klass);
//
//        assertThat(report.buildReport(studentsIDs), is(String.format(outputString, "")));
//    }
//
//    @Test
...
//        Report report = new Report(klass);
//
//        assertThat(report.buildReport(studentsIDs), is(String.format(outputString, stuLS)));
//    }
//
//}
